...
# write.csv(cum_data, file = "MSEswqs1.csv")
# # Scenario 2
# cum_data <- data.frame()
...
# write.csv(cum_data, file = "MSEswqs2.csv")
# # Scenario 3
# cum_data <- data.frame()
...
# write.csv(cum_data, file = "MSEswqs3.csv")
# # Scenario 4
# cum_data <- data.frame()
...
# write.csv(cum_data, file = "MSEswqs4.csv")
# # Scenario 5
# cum_data <- data.frame()
...
# write.csv(cum_data, file = "MSEswqs5.csv")
# Scenario 6
cum_data <- data.frame()
...
write.csv(cum_data, file = "MSEswqs6.csv")
