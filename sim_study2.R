...
run_custom_sce_simulations <- function(n, d, tau, sce, simulations = 1, nlambdas = 50, 
  ...
  for (i in 1:simulations) {
    ...
    else if (sce == 7) {vals <- scenario7(n, d, tau)}
    else if (sce == 8) {vals <- scenario8(n, d, tau)}
    else if (sce == 9) {vals <- scenario9(n, d, tau)}
    else if (sce == 10) {vals <- scenario10(n, d, tau)}
    else if (sce == 11) {vals <- scenario11(n, d, tau)}
    else if (sce == 12) {vals <- scenario12(n, d, tau)}
    else if (sce == 13) {vals <- scenario13(n, d, tau)}
    else if (sce == 14) {vals <- scenario14(n, d, tau)}
    else if (sce == 15) {vals <- scenario15(n, d, tau)}
    else if (sce == 16) {vals <- scenario16(n, d, tau)}
    else {stop("Only 0-16 scenarios at the time of this functions' construction")}
...
# Construct Table
{
  # Scenario 8
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.5, 8, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.5, 8, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.5, 8, simulations = 2))
  # write.csv(cum_data, file = "scenario8_05.csv")
  
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.2, 8, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.2, 8, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.2, 8, simulations = 2))
  # write.csv(cum_data, file = "scenario8_02.csv")
  # 
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.8, 8, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.8, 8, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.8, 8, simulations = 2))
  # write.csv(cum_data, file = "scenario8_08.csv")
  # 
  # # Scenario 9
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.5, 9, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.5, 9, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.5, 9, simulations = 2))
  # write.csv(cum_data, file = "scenario9_05.csv")
  # 
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.2, 9, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.2, 9, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.2, 9, simulations = 2))
  # write.csv(cum_data, file = "scenario9_02.csv")
  # 
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.8, 9, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.8, 9, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.8, 9, simulations = 2))
  # write.csv(cum_data, file = "scenario9_08.csv")
  # 
  # # Scenario 10
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.5, 10, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.5, 10, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.5, 10, simulations = 2))
  # write.csv(cum_data, file = "scenario10_05.csv")
  # 
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.2, 10, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.2, 10, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.2, 10, simulations = 2))
  # write.csv(cum_data, file = "scenario10_02.csv")
  # 
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.8, 10, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.8, 10, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.8, 10, simulations = 2))
  # write.csv(cum_data, file = "scenario10_08.csv")
  # 
  # # Scenario 11
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.5, 11, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.5, 11, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.5, 11, simulations = 2))
  # write.csv(cum_data, file = "scenario11_05.csv")
  # 
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.2, 11, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.2, 11, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.2, 11, simulations = 2))
  # write.csv(cum_data, file = "scenario11_02.csv")
  # 
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.8, 11, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.8, 11, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.8, 11, simulations = 2))
  # write.csv(cum_data, file = "scenario11_08.csv")
  # # Scenario 12
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.5, 12, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.5, 12, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.5, 12, simulations = 2))
  # write.csv(cum_data, file = "scenario12_05.csv")
  # # Scenario 13
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.5, 13, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.5, 13, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.5, 13, simulations = 2))
  # write.csv(cum_data, file = "scenario13_05.csv")
  # # Scenario 14
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.5, 14, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.5, 14, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.5, 14, simulations = 2))
  # write.csv(cum_data, file = "scenario14_05.csv")
  # # Scenario 15
  # cum_data <- data.frame()
  # cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.5, 15, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.5, 15, simulations = 2))
  # cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.5, 15, simulations = 2))
  # write.csv(cum_data, file = "scenario15_05.csv")
  # # Scenario 16
  cum_data <- data.frame()
  cum_data <- rbind(cum_data, run_custom_sce_simulations( 500, 10, 0.5, 16, simulations = 2))
  cum_data <- rbind(cum_data, run_custom_sce_simulations(1000, 10, 0.5, 16, simulations = 2))
  cum_data <- rbind(cum_data, run_custom_sce_simulations(2500, 10, 0.5, 16, simulations = 2))
  write.csv(cum_data, file = "scenario16_05.csv")
}


############################################
# Next Code is for plots scenarios 5, 6, 7, 8, 9, 10, 11 # 
############################################
